...
- [x] 60-02-PLAN.md — OpenAPI spec, Spectral lint, Swagger UI (API-03)
- [x] 60-03-PLAN.md — CLI tool with subcommands (CLI-01, CLI-02, CLI-03, CLI-04)
...
| 60. Public REST API + OpenAPI | v2.0 | 2/3 | In Progress|  |
