...
// Phase 54-02: Mimicry enforcement for inbound reply delivery. DO NOT REMOVE.
...
async function deliverWahaReply(params: {
  ...
  // presenceCtrl stops the "thinking" indicator from phase presence controller.
  // DO NOT CHANGE — must stop presenceCtrl typing BEFORE enforceMimicry fires its own typing.
  if (presenceCtrl) {
  ...
  // Runs AFTER presenceCtrl stops "thinking" typing and BEFORE the actual send.
